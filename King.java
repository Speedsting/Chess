...
public class King {
    ...
    public King(int xLoc, int yLoc, int squareSize) {
        this.xLoc       = xLoc;
        this.yLoc       = yLoc;
        this.squareSize = squareSize;
        
        try {
            image = ImageIO.read(this.getClass().getResourceAsStream("Images/whiteKing.png"));
        } catch(Exception e) {}
    }
